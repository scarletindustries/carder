...
|---|---|---|---|
| **R14-01** Keystone: `RefFuncImport` node + lower split + IR plumbing | `unclaimed` | — | `«REFFUNC-IMPORT-FROZEN»`; byte-identical (imported `ref.func` still skips exactly as today); conservative fail-closed emit arm for R14-02 to complete. |
