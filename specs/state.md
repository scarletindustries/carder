...
| `«PORFFOR-ABI»` — the four intrinsics a/b/c/d + the `(f64,i32)` value ABI + entry `"m"`/mem `"$"`/tags `"0"…` + `porf run` oracle (T10–T13) | P7-01/08 | **prose frozen by P7-01** (impl → P7-08) | 08,09 |
