...
%%% `carder_codegen_ffi`/`carder_rt_state_ffi`. Tier-P/O: pure BEAM terms +
...
%%%   dictionary under `{carder_rt_js_cell, Ref}`.
...
-define(CELL_KEY(Ref), {carder_rt_js_cell, Ref}).
