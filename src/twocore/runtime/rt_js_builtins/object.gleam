...
import twocore/runtime/rt_js_types.{
  ...
  ObjectGroupBy, ObjectHasOwn, ObjectIs, ObjectIsExtensible, ObjectIsFrozen,
  ObjectIsSealed, ObjectKeys, ObjectN, ObjectPreventExtensions,
  ObjectPrototypeDefineGetter, ObjectPrototypeDefineSetter,
  ObjectPrototypeHasOwnProperty, ObjectPrototypeIsPrototypeOf,
  ObjectPrototypeLookupGetter, ObjectPrototypeLookupSetter,
  ObjectPrototypePropertyIsEnumerable, ObjectPrototypeProtoGetter,
  ObjectPrototypeProtoSetter, ObjectPrototypeToLocaleString,
  ObjectPrototypeToString, ObjectPrototypeValueOf, ObjectSeal,
  ObjectSetPrototypeOf, ObjectValues, ParsedDesc, ProxyObj, RegExpObj, SObject,
  SShapedObject, StringKey, StringObj, SymbolKey, classify, mk_bool, mk_null,
  mk_number, mk_object, mk_string, mk_symbol, mk_undefined,
}
