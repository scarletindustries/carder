...
fn resolve_js(op: String) -> Option(String) {
  case op {
    ...
    // built-in constructors as first-class values (Array/Object/String/…)
    "builtin_ctor" -> Some("builtin_ctor")
    "builtin_prototype" -> Some("builtin_prototype")
    "to_object" -> Some("to_object")
    ...
    "func_bind" -> Some("func_bind")
    "fit_list" -> Some("fit_list")
    "array_to_list" -> Some("array_to_list")
    "apply_arg_list" -> Some("apply_arg_list")
    ...
    "string_from_code_point" -> Some("string_from_code_point")
    "string_raw" -> Some("string_raw")
    "date_now" -> Some("date_now")
    "date_new" -> Some("date_new")
    "date_utc" -> Some("date_utc")
    "date_parse" -> Some("date_parse")
    "date_call" -> Some("date_call")
    ...
    "js_m_set" -> Some("js_m_set")
    "js_m_get" -> Some("js_m_get")
    "js_m_add" -> Some("js_m_add")
    ...
    "array_reduce_right" -> Some("array_reduce_right")
    "array_reduce_right1" -> Some("array_reduce_right1")
    ...
    "object_prevent_extensions" -> Some("object_prevent_extensions")
    "object_is_extensible" -> Some("object_is_extensible")
    "object_seal" -> Some("object_seal")
    "object_is_sealed" -> Some("object_is_sealed")
