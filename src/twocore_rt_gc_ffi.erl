%%% twocore_rt_gc_ffi — the WebAssembly GC arena (this proposal).
%%%
%%% Hand-written Erlang (so it carries the `twocore_` namespace prefix and can
...
%%%
%%% Numbers follow 2core's convention: an i32 is its UNSIGNED bit pattern in
