//// Unit 11c — the carder **CLI**, exposing EVERY pipeline stage independently (high-level
//// decision #5) plus the end-to-end `run`. `gleam run -- <subcommand> …` dispatches here.
////
//// The stage wiring and per-stage error mapping (D4) live in `carder/pipeline`; this
...
fn usage() -> String {
  string.join(
    [
      "carder — WASM → Core Erlang compiler (Phase 4). Usage:",
