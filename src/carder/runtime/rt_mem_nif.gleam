...
//// `"carder@runtime@rt_mem_nif"`; `emit_core` stays tier-agnostic (it reads only `mem_module`,
...
//// (`c_src/carder_rt_mem_nif.c`) is attached to the shim `carder_rt_mem_nif_ffi`:
////
...
////   `carder/runtime/rt_mem`, byte-identical by construction. This preserves the Phase-11
...
// `carder_rt_mem_nif_ffi`. Every load/store passes the COMBINED `ea` (never `addr`/`offset`
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_fresh")
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_load")
fn nif_load(
  res: Dynamic,
  bytes: Int,
  signed: Bool,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_store")
fn nif_store(
  res: Dynamic,
  bytes: Int,
  ea: Int,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_load_bytes")
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_store_bytes")
fn nif_store_bytes(
  res: Dynamic,
  ea: Int,
  bytes: BitArray,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_fill")
fn nif_fill(
  res: Dynamic,
  dest: Int,
  value: Int,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_copy")
fn nif_copy(
  dst_res: Dynamic,
  src_res: Dynamic,
  dst: Int,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_init")
fn nif_init(
  res: Dynamic,
  seg: BitArray,
  dst: Int,
...
@external(erlang, "carder_rt_mem_nif_ffi", "nif_store_unchecked")
