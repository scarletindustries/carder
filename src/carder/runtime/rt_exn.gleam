...
//// P7-07 fills the bodies over the frozen terms (via the `carder_rt_exn_ffi` shim).
////
...
@external(erlang, "carder_rt_exn_ffi", "capture_exnref")
...
@external(erlang, "carder_rt_exn_ffi", "rethrow_exnref")
