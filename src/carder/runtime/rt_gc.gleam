...
//// lowers to `call 'carder@runtime@rt_gc':'<op>'(...)`. Each function here is a
//// thin `@external` binding onto `carder_rt_gc_ffi`, which owns the per-process
...
@external(erlang, "carder_rt_gc_ffi", "struct_new")
...
@external(erlang, "carder_rt_gc_ffi", "array_copy")
pub fn array_copy(
  dst: Dynamic,
  dst_index: Int,
  src: Dynamic,
...
@external(erlang, "carder_rt_gc_ffi", "call_ref")
pub fn call_ref(
  funcref: Dynamic,
  args: List(Dynamic),
  result_count: Int,
...
@external(erlang, "carder_rt_gc_ffi", "t_call_ref")
pub fn t_call_ref(
  state: Dynamic,
  funcref: Dynamic,
  args: List(Dynamic),
...
@external(erlang, "carder_rt_gc_ffi", "apply_ref")
...
/// `#(package, state')`.
@external(erlang, "carder_rt_gc_ffi", "t_apply_ref")
pub fn t_apply_ref(
  state: Dynamic,
  funcref: Dynamic,
  args: List(Dynamic),
...
@external(erlang, "carder_rt_gc_ffi", "array_new_data")
...
@external(erlang, "carder_rt_gc_ffi", "array_init_data")
...
@external(erlang, "carder_rt_gc_ffi", "array_new_elem")
...
@external(erlang, "carder_rt_gc_ffi", "array_init_elem")
