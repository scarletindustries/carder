...
//// (`emit_core` captures a compile-time-literal `'carder@wasm@<mod>':'f<idx>'/arity` inside it),
...
/// default `0` = null). `arity >= 1`. Reuses `carder_rt_mem_atomics_ffi` (the same `{signed,
