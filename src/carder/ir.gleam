//// The shared, language-neutral intermediate representation — the keystone of carder.
////
...
////    `test/carder/ir/strawman_test.gleam`.
...
/// - `FuelExhausted`: the carder CPU-fuel resource bound was exhausted (Phase-3, F5). This is
