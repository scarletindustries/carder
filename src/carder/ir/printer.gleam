...
////
//// Renders a `carder/ir` `Module` to its **canonical, lossless, deterministic**
...
//// and reload it with `carder/ir/parser.parse_module`; the two satisfy the D7
...
/// is its EXACT inverse, proven by the full-surface round-trip (`test/carder/ir/roundtrip_test`).
