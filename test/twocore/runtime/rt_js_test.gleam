...
import twocore/runtime/rt_js as js
...
/// Apply `M:F(Args)` catching a raise as `Error(text)` (see test/twocore_emit_test_ffi.erl) —
...
fn rt_js_module() -> Atom {
  atom.create("twocore@runtime@rt_js")
}
