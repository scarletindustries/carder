...
# live Porffor/Node install (mirroring test/twocore/porffor/fixtures/ + conformance/vendor). Re-run
...
# in corpus.gleam, never a corpus entry we hold 2core to). Skips gracefully if Porffor is absent.
set -euo pipefail
