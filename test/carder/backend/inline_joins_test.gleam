...
// Test-only FFI (see `test/carder_emit_test_ffi.erl`): apply `M:F(Args)` and capture a trap as
...
fn wrap(body: CExpr) -> CModule {
  CModule(name: "carder@inline@t", exports: [], attributes: [], defs: [
