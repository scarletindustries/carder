...
////
//// The acceptance is the ROUND-TRIP: `Unbox∘Box` is the identity, bit-exactly. Because carder
...
@external(erlang, "carder_boxing_test_ffi", "f64_bits")
fn f64_bits(f: Float) -> Int

@external(erlang, "carder_boxing_test_ffi", "f32_bits")
