...
import carder/js/porffor
import carder/pipeline
import carder/runtime/porffor_abi.{PNumber}
...
const fixture_dir = "test/carder/porffor/fixtures/"
...
/// carder pipeline under `profiles.porffor()`, the WASM/JS exception handling executes as native
