...
////
//// The committed fixture `test/carder/teavm/compute.wasm` is TeaVM 0.15.0's WASM GC output for
//// `test/carder/teavm/Client.java` (see that file to rebuild). It imports the TeaVM host runtime
...
const teavm_wasm = "test/carder/teavm/compute.wasm"
