...
////
//// Exceptions are caught via the namespace-hygienic `carder_rt_state_test_ffi` helper
//// (pure Gleam cannot `catch`).

import carder/runtime/rt_meter
import carder/runtime/rt_state.{FullDecl, StateDecl}
...
/// raised at all (E3: never read garbage). See `carder_rt_state_test_ffi`.
