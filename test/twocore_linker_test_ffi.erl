%%% twocore_linker_test_ffi — test-only helper for the P11-03 linker suite.
%%%
%%% Mirrors the existing `test/twocore_*_test_ffi.erl` convention (a hand-written
...
-module(twocore_linker_test_ffi).
...
synth_dir() ->
    ...
    filename:join(Tmp, "twocore_linker_synth").
